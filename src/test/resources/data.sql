...
VALUES (1, 'Javaコース', '2024-01-10', '2024-05-10'),
       ...
       (1, 'Javaコース', '2024-05-05', '2024-09-05'),
       (2, 'Javaコース', '2024-10-26', '2025-10-26'),
       (3, 'AWSコース', '2024-11-06', '2025-11-06'),
       (4, 'AWSコース', '2024-11-06', '2025-11-06'),
       (1, 'AWSコース', '2024-11-08', '2025-11-08'),
       (2, 'AWSコース', '2024-11-08', '2025-11-08');
